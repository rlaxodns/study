...
print(x_train.shape, x_test.shape) #(7620, 8, 1) (3266, 8, 1)
...
model.add(Conv1D(50, 2, input_shape = (x_train.shape[1], 1)))
model.add(Flatten())
...
hist = model.fit(x_train, y_train, epochs=50, batch_size = 256,
