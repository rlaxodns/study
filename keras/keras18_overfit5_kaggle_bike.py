...
x_train, x_test, y_train, y_test = train_test_split(x,y, test_size=0.1, random_state=2887)
...
plt.rcParams['font.family'] = 'Malgun Gothic' # 한글화

plt.figure(figsize=(10,10))
plt.plot(hist.history['loss'], c = 'purple', label = 'loss')
