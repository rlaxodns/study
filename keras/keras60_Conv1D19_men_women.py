...
print(x_train.shape, x_test.shape) #(27163, 100, 100, 3) (1908, 100, 100, 3)
...
print(x_train.shape, x_test.shape) #(27163, 100, 300) (1908, 100, 300)
...
model = Sequential()
model.add(Conv1D(32,3, input_shape = (100,300), activation='relu'))
