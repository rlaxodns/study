...
# print(np.argmax(cum)+1)  # 4 # 인덱스라서 +1을 해줘야함
# print(np.argmax(cum>= 0.999)+1) # 4
# print(np.argmax(cum>= 0.99)+1)  # 3
# print(np.argmax(cum>= 0.95)+1)  # 2
...
"""
1/1 [==============================] - 0s 74ms/step - loss: 0.3117 - acc: 0.9667
로스 [0.31168681383132935, 0.9666666388511658] 정확도 0.9666666666666667
1/1 [==============================] - 0s 56ms/step - loss: 0.0143 - acc: 1.0000
로스 [0.014251811429858208, 1.0] 정확도 1.0
1/1 [==============================] - 0s 52ms/step - loss: 0.0035 - acc: 1.0000
로스 [0.0035072837490588427, 1.0] 정확도 1.0
"""
