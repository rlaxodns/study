...
# print(np.argmax(cum>= 0.95)+1)  # 7
    ...
    #2. 모델
    model = Sequential()
    model.add(Dense(1000, activation = 'relu', input_dim = x_train1.shape[1]))
    ...
    hist = model.fit(x_train1, y_train, epochs=100, batch_size = 256,
...
"""
loss 20644.623046875
r2 0.35760420871882426
103/103 [==============================] - 0s 1ms/step - loss: 21157.9336
loss 21157.93359375
r2 0.34163180002663684
"""
