...
print(y_train.shape, y_test.shape) #(25000, 100, 300) (12500, 100, 300)
...
for i in range(0, len(num), 1):
    ...
    model = Sequential()
    model.add(Conv1D(16, 3, input_shape=(x_train1.shape[1],), activation='relu')) 
    ...
    start = time.time()
    hist = model.fit(x_train1, y_train, epochs=10, batch_size=16,
    ...
    y_pre = model.predict(x_test1, batch_size=16)
