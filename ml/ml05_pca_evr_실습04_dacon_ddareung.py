...
for i in range(2):
    ...
    # print(np.argmax(cum)+1)  # 9 # 인덱스라서 +1을 해줘야함
    # print(np.argmax(cum>= 0.999)+1) # 9
    # print(np.argmax(cum>= 0.99)+1)  # 9
    ...
    hist = model.fit(x_train1, y_train, epochs=10, batch_size=1,
    ...
    # aaa.append[i+1, x[i], r2, loss]

# for bbb in aaa:
#     print(bbb[0], bbb[1], "r2",bbb[2], "loss",bbb[3])
...
"""
loss 2643.366943359375
r2 -4.266603073736634
9/9 [==============================] - 0s 1ms/step - loss: 2549.5896
loss 2549.589599609375
r2 -3.7858877218398224"""
