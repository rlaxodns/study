...
# print(np.argmax(cum)+1)  # 30 # 인덱스라서 +1을 해줘야함
# print(np.argmax(cum>= 0.999)+1) # 24
# print(np.argmax(cum>= 0.99)+1)  # 17
# print(np.argmax(cum>= 0.95)+1)  # 10
    ...
    #4. 예측 및 평가
    loss = model.evaluate(x_test1, y_test) #[0.3684210479259491, 0.6315789222717285(accuracy)]
